...
import resume from '../../assets/CV_Aiman_Syeda_Word.pdf';
  ...
  return (
    <section id='intro'>
      <div className='introContent'>
        ...
        <a href={resume} download='Aiman-Syeda-Resume'><button className='hiremeBtn'><img src={downloadiconbtn} className='downloadImg' alt='' />Download Resume</button></a>
      </div>
